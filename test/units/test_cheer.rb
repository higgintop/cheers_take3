...
class TestCheer < Minitest::Test
  ...
  def test_birthday_today
    ...
    actual = Cheer.for_birthday("#{todayDate.month}/#{todayDate.day}")
  ...
  def test_birthday_tomorrow
    ...
    actual = Cheer.for_birthday("#{tomorrowDate.month}/#{tomorrowDate.day}")
    expected = "Awesome! Your birthday is in 1 day! Happy Birthday in advance!"
    assert_equal actual, expected
  end

  def test_birthday_yesterday
    yesterdayDate = Date.today + 364
    actual = Cheer.for_birthday("#{yesterdayDate.month}/#{yesterdayDate.day}")
  ...
  def test_birthday_in_near_future
    ...
    expected = "Awesome! Your birthday is in 23 days! Happy Birthday in advance!"
    assert_equal actual, expected
  end
